 ...
 */
public class BaidumapActivity06  extends Activity implements OnGetRoutePlanResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidumap_activity06);
        mapView = (MapView) findViewById(R.id.baidumapactivity06_mapview);
        btn = (Button)findViewById(R.id.baidumapactivity06_btn);
