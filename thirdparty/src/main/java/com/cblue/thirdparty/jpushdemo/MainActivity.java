package com.cblue.thirdparty.jpushdemo;
...
public class MainActivity extends InstrumentedActivity implements OnClickListener {
    ...
    private Button mInit; //初始化推送
    private Button mStopPush; //停止推送
    private Button mResumePush; //重置推送
    private Button mGetRid; //得到注册ID
    private Button mSetting;//跳转到设置界面


    private TextView mRegId; //显示注册ID
    private EditText msgText;//得到推送的信息
